...
<div id="primary" class="content-area">
	...
	<?php if ($owner) : ?>
		<form method="post" action="<?php echo esc_url( admin_url('admin-post.php') ); ?>" enctype="multipart/form-data">
			<input type="hidden" name="action" value="ac_media_update" />
   	...
   	<?php endif; ?>
			...
			<?php if ($owner) : ?>
				<div class="row owner-actions-footer">
					<div class="hr"></div>
					<div class="col-xs-2">
						<?php wp_nonce_field('ac_media_delete_ajax', 'ac_media_delete_nonce'); ?>
						<a id="audubon-core-delete-media" href="#" class="btn btn-danger ajax-btn">Delete Media</a>
					</div>
					<div class="col-xs-2 col-xs-offset-8">
					    <?php wp_nonce_field('ac_media_update_post', 'ac_media_update_nonce'); ?>
						<input class="btn btn-primary ac-right" type="submit" name="update" value="Update Media" />
					</div>
				</div>
			<?php endif; ?>
