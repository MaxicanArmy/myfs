...
?>
    ...
    */
    ...
    // echo '<pre>';  var_dump( $fossil );  echo '</pre>';    
    
   // var_dump( $item_query );    //string(19) "537,619,620,593,551"
...
?>
    ...
    <?php if ( bp_has_activities( 'activity' .
        ...
        <?php while ( bp_activities() ): ?>
            <?php bp_the_activity(); ?>
            <?php if ( $activities_template->activity->item_id == $fossil->id || $activities_template->activity->secondary_item_id == $fossil->id): ?>
