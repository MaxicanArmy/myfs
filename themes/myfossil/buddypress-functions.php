...
if (!class_exists('BP_Legacy')):
    ...
    class BP_Legacy extends BP_Theme_Compat
    {
        ...
        public function enqueue_scripts()
        {
           ...
           // Locate the mentions file
           /*
            $asset = $this->locate_asset_in_stack("mentions.min.js", 'js');
            
            if (isset($asset['location'], $asset['handle'])) {
               // var_dump( $asset );
               // array(2) { ["location"]=> string(89) "http://myfossil.staging.wpengine.com/wp-content/themes/myfossil/static/js/mentions.min.js" ["handle"]=> string(12) "bp-parent-js" }
                wp_enqueue_script($asset['handle'], $asset['location'], array(), $this->version);
