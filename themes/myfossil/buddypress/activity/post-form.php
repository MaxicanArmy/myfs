            ...
            */
            ...
            <div class="status-update-body">
	            ...
	            <?php 
					...
					?>
						Send <?php bp_displayed_user_fullname(); ?> a public message: <br/>
						 <div id="whats-new-textarea" class="form-group">
						
							<textarea class="form-control bp-suggestions" name="whats-new" id="whats-new">@<?php  bp_displayed_user_mentionname(); ?>&nbsp;</textarea>	
		                </div>            
	                <?php            
					}
					else {
