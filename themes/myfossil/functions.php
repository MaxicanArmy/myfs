...
//do_action( 'myfossil_fossil_activity_posted', $post_id, $sender_id, $comment, $fossil_author_id ); // added to file below
//See:  D:\jobs\MyFossil\myfossil-specimen-master\includes\class-myfossil-specimen.php L. 416
...
//do_action( 'bp_activity_comment_posted', $comment_id, $r, $activity ); ////bp_activity_new_comment()
...
function mf_ufl_register( $registration_url ) {
	...
	$registration_url = '<a href="https://ufl.qualtrics.com/SE/?SID=SV_6yyUqjIkXNLl6Tj&Q_JFE=0" target="_blank">Create New Account!</a><br/>&nbsp;<br/>';
