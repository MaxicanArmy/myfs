	...
	<div id="new-reply-<?php bbp_topic_id(); ?>" class="bbp-reply-form">
		...
		<form id="new-post" name="new-post" method="post" action="<?php the_permalink(); ?>">
			...
			<fieldset class="bbp-form">
				...
				<div class="bbp-template-notice">
					<p><?php _e( '<b>Image Upload Instructions</b><br /> Click "Choose File" under the ATTACHMENTS heading below and select your image.  The image will upload when you submit your topic.', 'bbpress' ); ?></p>
				</div>
