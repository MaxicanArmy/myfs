	...
	<div id="new-topic-<?php bbp_topic_id(); ?>" class="bbp-topic-form">
		...
		<form id="new-post" name="new-post" method="post" action="<?php the_permalink(); ?>">
			...
			<fieldset class="bbp-form">
				...
				<div class="bbp-template-notice">
					<p><?php _e( '<b>Image Upload Instructions</b><br /> <span style="font-weight:300;">Click "Choose File" under the ATTACHMENTS heading below and select your image.  The image will upload when you submit your topic.</span>', 'bbpress' ); ?></p>
				</div>
				
				<div class="bbp-template-notice">
					<p><?php _e( '<b>Mention Other myFOSSIL Users</b><br /> <span style="font-weight:300;">To mention other myFOSSIL users (which will send them a notification), you can type the "@" symbol, followed by the myFOSSIL user name of the person you would like to mention.</span>', 'bbpress' ); ?></p>
				</div>
				...
				<div>
					...
					<?php if ( bbp_allow_topic_tags() && current_user_can( 'assign_topic_tags' ) ) : ?>
						...
						<div class="bbp-template-notice">
							<p><?php _e( 'Tags are broad terms used to describe the content of posts. This helps improve the search capability within the forums. Separate each tag you enter with a comma. (e.g. triassic, vertebrates, teeth, webinar)', 'bbpress' ); ?></p>
						</div>
