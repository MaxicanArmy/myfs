...
<?php if ( bp_has_members( bp_ajax_querystring( 'members' ) ) ) : ?>
	...
	<?php while ( bp_members() ) : bp_the_member(); ?>
		...
		<tr>
            ...
            <td  class="action">Fossils: <?php // function is in myfossil/functions.php
			...
			if( $location == NULL || $location == false ) 
				$location = 'Unknown'; 
			?>
            <td  class="action"><?php echo $location; ?></td>
            
            <!-- Friend button -->
			<td class="action"><?php do_action( 'bp_directory_members_actions' ); ?></td>             
