...
?>
<?php if ( bp_has_members( 'per_page=999&user_id=' . bp_displayed_user_id() ) ): ?>
    ...
    <div id="side-resources">
        ...
        if ( $n_members > $n_members_to_show ) {
            printf("<div class=\"pull-right clearfix\"><a href=\"%sfriends/\">See all %d</a></div>", bp_core_get_user_domain( bp_displayed_user_id() ), $n_members );
        }
        ?>
    </div>
<?php endif; ?>
