...
function myfossil_scripts()
{
    ...
    wp_enqueue_style('myfossil-style', get_template_directory_uri() . '/style.css', array(), '2.2.1');
    ...
    wp_enqueue_script ( 'atmo-custom', get_template_directory_uri() . '/js/custom.js', array(), '2.1.3' );
}
