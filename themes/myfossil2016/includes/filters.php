 ...
 */
/* NOT REMOVING THIS FUNCTION TOTALLY FUCKS THE OUTPUT OF BUDDYPRESS ACTIVITY STREAM COMMENTS
...
/*
 * Commented out by Max Jones on 08-10-16. This code wrecks the styling on the login page and the previous fix had been to make a change to a core file. Bad idea dum-dum.
 *
...
function myfossil_member_customer_search_form( $html ) {
    $search_value = !empty( $_REQUEST['s'] ) ? stripslashes( $_REQUEST['s'] ) : "Search by Name or Location";
    return '<form action="" method="get" id="search-members-form">
        <label for="members-search" class="label-control">Enter a name or location to find myFOSSIL members:</label>
