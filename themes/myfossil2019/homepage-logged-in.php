    ...
    <div id="homepage" class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-9 col-lg-10">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 recent-forum-widget">
                        ...
                        <div class="featured-forum-post" style="padding:0 50px 0 50px;">
                            ...
                            <?php
                                ...
                                echo '<div class="post-details"><h3>Featured Forum Post</h3><p class="title">'.$forum.'</p><p class="topic-title">'.$title.'</p></div></div>';
                            ?>
                        </div>
                        <?php
                        $reply_args = array(
                ...
                <div id="homepage-whats-new" class="row">
                    <div class="col-sm-12">
