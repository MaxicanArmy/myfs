...
if (!function_exists('myfs2020_child_setup')):
...
add_action('after_setup_theme', 'myfs2020_child_setup');

function my_theme_enqueue_styles() {

  $parent_style = 'myfs2020'; // This is 'twentyfifteen-style' for the Twenty Fifteen theme.
